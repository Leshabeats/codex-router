...
// This module is an unadvertised routing primitive.  The current Codex
// delegation path is generated by codex-agent-catalog.mjs and does not call a
// weighted fallback planner, so keeping this module out of the catalog is
// intentional until that caller exists.
